@extends('layouts.app')
@section('title','vendor general cargo')
@section('content')
<div class="container">
        ...
        <hr> 
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="/vendor-general-cargo/create" class = "btn btn-danger btn-sm">Input Data Baru </a>
            ...
            <div class="modal-dialog modal-lg">
              <form method="post" id="form-import" action="{{route('importdatavendorvoyage')}}" enctype="multipart/form-data" class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>Import data vendor general cargo sesuai format contoh berikut.<br /><a href="{{url('')}}/vendor-general-cargo.xlsx"><i class="fas fa-download"></i> File Contoh Excel vendor general cargo</a></p>
                    </div>
                    <div class="col-md-12">
                      <label>File Excel vendor general cargo</label>
                      <input type="file" name="vendor-general-cargo" required>
                    </div>
                  </div>
                </div>
...
$(function() {
    $('#users-table').DataTable(
        ...
        "scrollY": 200,
        "scrollX": true,
        ajax: '/vendor-general-cargo/json',
        columns: [
