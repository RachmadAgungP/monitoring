@extends('layouts.app')
@section('title','Jasa General Cargo ')
@section('content')
<div class="container">
    ...
    <div class="col-md-14">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="/jasa-general-cargo/create" class="btn btn-danger btn-sm">Input Data Baru </a>
            ...
            <div class="modal-dialog modal-lg">
              <form method="post" id="form-import" action="{{route('importdatageneralcargo')}}" enctype="multipart/form-data" class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Import Data Jasa General Cargo nama file harus sama</h4>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>Import data Jasa General Cargo sesuai format contoh berikut.<br /><a href="{{url('')}}/jasa-general-cargo.xlsx"><i class="fas fa-download"></i> File Contoh Excel Jasa General Cargo </a></p>
                    </div>
                    <div class="col-md-12">
                      <label>File Excel Jasa General Cargo </label>
                      <input type="file" name="jasa-general-cargo" required>
                    </div>
                  </div>
                </div>
          ...
          <a class="btn btn-primary btn-sm" href="/jalur-general-cargo">JALUR general cargo </a>
          <a class="btn btn-primary btn-sm" href="/vendor-general-cargo">VENDOR general cargo </a>
