...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Input data jalur general cargo </div>
                <div class="card-body">
                @include('validation_error')
                    {{ Form::open(['url'=>'jalur-general-cargo']) }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                {{ Form::select('asal',$asal,null,['class'=>'from-control selects','placeholder'=>'Asal'])}}
                            </div>
                        </div>
                        <div class="form-group row">
