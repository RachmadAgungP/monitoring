    ...
    <div class="col-md-14">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="/rekap-alih-stok/create" class="btn btn-danger btn-sm">Input Data Baru </a>
          <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-import">Import data Excel</button>
          <div class="modal fade" id="modal-import">
            <div class="modal-dialog modal-lg">
              <form method="post" id="form-import" action="{{route('importdatacontainer')}}" enctype="multipart/form-data" class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Import Data Rekap Alih Stok nama file harus sama</h4>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>Import data Rekap-Alih Stok sesuai format contoh berikut.<br /><a href="{{url('')}}/rekap-alih-stok.xlsx"><i class="fas fa-download"></i> File Contoh Excel Rekap-Alih Stok </a></p>
                    </div>
                    <div class="col-md-12">
                      <label>File Excel Rekap-Alih Stok </label>
                      <input type="file" name="rekap-alih-stok" required>
                    </div>
                  </div>
                </div>
          ...
          <a class="btn btn-primary btn-sm" href="/jalur-alihstok">JALUR ALIH STOK </a>
          <a class="btn btn-primary btn-sm" href="/vendor-alihstok">VENDOR ALIH STOK </a>
