        ...
        <hr> 
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="/vendor-kapal-layar/create" class = "btn btn-danger btn-sm">Input Data Baru </a>
            ...
            <div class="modal-dialog modal-lg">
              <form method="post" id="form-import" action="{{route('importdatavendorvoyage')}}" enctype="multipart/form-data" class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>Import data vendor kapal layar sesuai format contoh berikut.<br /><a href="{{url('')}}/vendor-kapal-layar.xlsx"><i class="fas fa-download"></i> File Contoh Excel vendor kapal layar</a></p>
                    </div>
                    <div class="col-md-12">
                      <label>File Excel vendor kapal layar</label>
                      <input type="file" name="vendor-kapal-layar" required>
                    </div>
                  </div>
                </div>
