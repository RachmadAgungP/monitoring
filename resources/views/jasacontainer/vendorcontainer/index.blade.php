        ...
        <hr> 
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="/vendor-container/create" class = "btn btn-danger btn-sm">Input Data Baru </a>
            ...
            <div class="modal-dialog modal-lg">
              <form method="post" id="form-import" action="{{route('importdatavendorcontainer')}}" enctype="multipart/form-data" class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>Import data vendor container sesuai format contoh berikut.<br /><a href="{{url('')}}/vendor-container.xlsx"><i class="fas fa-download"></i> File Contoh Excel vendor container</a></p>
                    </div>
                    <div class="col-md-12">
                      <label>File Excel vendor container</label>
                      <input type="file" name="vendor-container" required>
                    </div>
                  </div>
                </div>
