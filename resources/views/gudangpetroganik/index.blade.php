@extends('layouts.app')
@section('title','Gudang Petroganik ')
@section('content')
<div class="container">
    ...
    <div class="col-md-14">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="/gudang-petroganik/create" class="btn btn-danger btn-sm">Input Data Baru </a>
          <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-import">Import data Excel</button>
          <div class="modal fade" id="modal-import">
            <div class="modal-dialog modal-lg">
              <form method="post" id="form-import" action="{{route('importDataGudangpetroganik')}}" enctype="multipart/form-data" class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Import Data Gudang Petroganik nama file harus sama</h4>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>Import data Gudang Petroganik sesuai format contoh berikut.<br /><a href="{{url('')}}/gudang-petroganik.xlsx"><i class="fas fa-download"></i> File Contoh Excel Gudang Petroganik </a></p>
                    </div>
                    <div class="col-md-12">
                      <label>File Excel Gudang Petroganik </label>
                      <input type="file" name="gudang-petroganik" required>
                    </div>
                  </div>
                </div>
