...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Input Data Rute tarip franco </div>
                <div class="card-body">
                    @include('validation_error')
                    {{ Form::open(['url'=>'jalur-taripfranco']) }}
...
<script>
    ...
    $(".asalfilter").on('change', function() {
        ...
        if (categorys != '0' && categorys != 0) {
            $.ajax({
                url: "/jalur-taripfranco/categoryasalgudang/" + categorys,
                type: "GET",
    ...
    $(".tujuanfilter").on('change', function() {
        ...
        if (categorys != '0' && categorys != 0) {
            $.ajax({
                url: "/jalur-taripfranco/categorytujuangudang/" + categorys,
                type: "GET",
                // data: {'statuscategorys':statuscategorys},
                success: function(data) {
                    var dataObj = Object.values(data)[0];
