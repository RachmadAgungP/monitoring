@extends('layouts.app')
@section('title','Rekap Tarip Franco ')
@section('content')
<div class="container">
    ...
    <div class="col-md-14">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="/rekap-tarip-franco/create" class="btn btn-danger btn-sm">Input Data Baru </a>
          <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-import">Import data Excel</button>
          <div class="modal fade" id="modal-import">
            <div class="modal-dialog modal-lg">
              <form method="post" id="form-import" action="{{route('importdataRekaptaripfranco')}}" enctype="multipart/form-data" class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Import Data Rekap Tarip Franco nama file harus sama</h4>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>Import data Rekap-Tarip Franco sesuai format contoh berikut.<br /><a href="{{url('')}}/rekap-tarip-franco .xlsx"><i class="fas fa-download"></i> File Contoh Excel Rekap-Tarip Franco </a></p>
                    </div>
                    <div class="col-md-12">
                      <label>File Excel Rekap-Tarip Franco </label>
                      <input type="file" name="rekap-tarip-franco" required>
                    </div>
                  </div>
                </div>
          ...
          <a class="btn btn-primary btn-sm" href="/jalur-taripfranco">JALUR Tarip Franco </a>
          <a class="btn btn-primary btn-sm" href="/vendor-taripfranco">VENDOR Tarip Franco </a>
