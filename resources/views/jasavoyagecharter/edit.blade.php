        ...
        <div class="col-md-12">
            <div class="card">
                ...
                @include('validation_error')
                    ...
                    {{ Form::model($jasavoyagecharter,['url'=>'jasa-voyage-charter/'.$jasavoyagecharter->id,'method'=>'PUT']) }}
                        ...
                        <div class="col-md-6">
                            {{ Form::select('kode_rutes',$jalur_voyage,null,['class'=>'from-control','disabled','placeholder'=>'pilih rute'   ])}}
                        </div>
                    </div>
