@extends('layouts.app')
@section('title','Jasa voyage charter')
@section('content')
<div class="container">
    ...
    <div class="col-md-14">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="/jasa-voyage-charter/create" class="btn btn-danger btn-sm">Input Data Baru </a>
          <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modal-import">Import data Excel</button>
          <div class="modal fade" id="modal-import">
            <div class="modal-dialog modal-lg">
              <form method="post" id="form-import" action="{{route('importdatavoyagecharter')}}" enctype="multipart/form-data" class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Import Data jasa voyage charter nama file harus sama</h4>
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>Import data jasa voyage charter sesuai format contoh berikut.<br /><a href="{{url('')}}/jasa-voyage-charter.xlsx"><i class="fas fa-download"></i> File Contoh Excel jasa voyage charter</a></p>
                    </div>
                    <div class="col-md-12">
                      <label>File Excel jasa voyage charter</label>
                      <input type="file" name="jasa-voyage-charter" required>
                    </div>
                  </div>
                </div>
          ...
          <a class="btn btn-primary btn-sm" href="/jalur-voyage">JALUR VOYAGE CHARTER</a>
          <a class="btn btn-primary btn-sm" href="/vendor-voyage">VENDOR VOYAGE CHARTER</a>
  ...
  const table = $('#users-table').DataTable({
    ...
    columnDefs: [{
      ...
      },
      {
        ...
        "class": "text-nowrap",
        "render": function(data, type, row, meta) {
          return row.tarif_lebihdari_10000ton;
        }
      },
      {
        "targets": 4,
        "class": "text-nowrap",
        "render": function(data, type, row, meta) {
          return row.tarif_kurangdari_10000ton;
        }
      },
      {
        "targets": 5,
